...
class loginForm {
    ...
    async fetchLogin() {
        ...
        if (password.length < 8) {
            ...
            setAttributes(this.eRef,{placeholder:"Password too short!"})
    ...
    //Same as above, just different endpoint
    ...
    async fetchSignUp() {
        ...
        setUpHTML("input", { value: email, name: "username", class: "hiddenInput" }, form);
        setUpHTML("input", { value: password, name: "password", class: "hiddenInput" }, form);
